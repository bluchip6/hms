...
$sql = "UPDATE complaints SET response=:response WHERE id=:id";
...
$query->execute();
 ...
 header("Location: Allcomplaint.php");
...
<form class="text-center" style="color: #757575;" action="" method="post">
 ...
 <div class="md-form mt-3">
           <label>    Patient's Complaint </label> <input disabled type="text" value="<?php echo $complaint;?>" id="materialContactFormName" class="form-control" name="complaint" required>
...
<button name="reply" class="btn btn-outline-info btn-rounded btn-block my-4 waves-effect z-depth-0" type="submit">Respond to Complaint</button>
