...
$stm = $pdo->prepare("SELECT * FROM appointments WHERE email = :email");
...
echo "<tr><th>Appointments :</th> <td>" . $row['appointment'] ."<td>". PHP_EOL;
echo "<tr><th>Doctor's Response: </th><td>" . $row['response']."<td>" . PHP_EOL;
 ?>
    <!-- /.content-wrapper -->
