...
$app = $_POST['appointment'];   
  //$email=$_SESSION['email'];
$sql="INSERT INTO appointments(appointment,email,response) VALUES(:userAppointment,:userEmail,:res)";
$query = $dbh->prepare($sql);
$res="";
// Binding Post Values
$query->bindParam(':userAppointment',$app,PDO::PARAM_STR);
...
if($lastInsertId)
{
$msg="You have   Successfullyrequested for an appointment with the Doctor";
}
else
{
$error="Sorry, appointment request failed";
}
}
...
<div class="form-group">
  <label for="complaint">Appointment:</label>
  <textarea class="form-control" rows="10" cols="60" name="appointment"></textarea>
