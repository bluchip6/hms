...
<input type="radio"  name="sex" value="female" required>	<b>Female</b> <p>
...
<p>
    <label for="Insurance cover"><b>Insurance Cover</b></label>
     <input type="text" placeholder="Enter Insurance cover number" name="insurance" required>


<p>
    <label for="Address"><b>Contact Address</b></label>
     <Textarea type="text" placeholder="Enter Contact Address" name="address" required>
...
<p>
    ...
    <input type="password" placeholder="Enter Password" name="pass" minlength="4"  required>
